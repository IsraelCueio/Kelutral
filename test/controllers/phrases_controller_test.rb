...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference("Phrase.count") do
      post phrases_url, params: { phrase: { audio: @phrase.audio, difficulty: @phrase.difficulty } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { audio: @phrase.audio, difficulty: @phrase.difficulty } }
